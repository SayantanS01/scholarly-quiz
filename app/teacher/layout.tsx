    ...
    <div className="flex min-h-screen bg-background font-mono">
      ...
      <aside className="w-72 bg-black border-r border-primary fixed inset-y-0 z-50 overflow-hidden">
        ...
        <div className="p-8 mb-8">
          <Link href="/teacher" className="text-2xl font-black text-primary font-bold text-primary tracking-tighter">
            TEACHER_OS
          </Link>
          <div className="text-[10px] text-primary font-black mt-1">MODE: INSTRUCTOR_CORE</div>
        </div>
