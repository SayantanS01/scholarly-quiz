    ...
    <div className="flex min-h-screen bg-background font-mono">
      ...
      <aside className="w-72 bg-black border-r border-primary fixed inset-y-0 z-50 overflow-hidden">
        ...
        <div className="p-8 mb-8">
          <Link href="/student" className="text-2xl font-black text-primary font-bold text-primary tracking-tighter">
            STUDENT_OS
          </Link>
          <div className="text-[10px] text-primary font-black mt-1">ACCESS: GRANTED</div>
        </div>
        
        <nav className="px-6 space-y-4">
          <SidebarLink href="/student" label="OVERVIEW" />
          <SidebarLink href="/student/quizzes" label="LEARNING_NODES" />
          <SidebarLink href="/student/assignments" label="TASK_QUEUE" />
          <SidebarLink href="/student/results" label="SCORE_ARCHIVE" />
          <SidebarLink href="/student/leaderboard" label="RANKING_BOARD" />
        </nav>
