    ...
    <div className="flex min-h-screen bg-cyber-black font-mono">
      ...
      <aside className="w-72 bg-black border-r border-neon-cyan/20 fixed inset-y-0 z-50 overflow-hidden">
        ...
        <div className="p-8 mb-8">
          <Link href="/student" className="text-2xl font-black neon-text text-neon-cyan tracking-tighter">
            STUDENT_OS
          </Link>
          <div className="text-[10px] text-neon-magenta font-black mt-1">ACCESS: GRANTED</div>
        </div>
